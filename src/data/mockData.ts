...
export const producers: Producer[] = [
  {
    id: 'prod-001',
    name: createAIField('Sarah Thompson', 98, 'Producer name extracted from email signature', 'Email_Headers.json', '"from": "Sarah Thompson <sarah.thompson@brokerworks.com>"'),
    code: createAIField('BRK-2847', 99, 'Producer code from agency directory', 'Producer_Lookup.csv', '"producerCode": "BRK-2847"'),
    agency: createAIField('BrokerWorks Insurance', 99, 'Agency name from producer directory', 'Producer_Lookup.csv', '"agency": "BrokerWorks Insurance"'),
    license: createAIField('CA-LIC-892341', 97, 'License verified in state database', 'CA_License_Verification.json', '"licenseNumber": "CA-LIC-892341", "status": "Active"'),
    state: createAIField('CA', 99, 'State from license verification', 'CA_License_Verification.json', '"state": "CA"'),
    email: createAIField('sarah.thompson@brokerworks.com', 99, 'Email from submission header', 'Email_Headers.json', '"from": "sarah.thompson@brokerworks.com"'),
    phone: createAIField('(555) 234-5678', 95, 'Phone from producer directory', 'Producer_Lookup.csv', '"phone": "(555) 234-5678"'),
    tier: createAIField('preferred' as const, 98, 'Producer tier from agency relationship', 'Producer_Lookup.csv', '"tier": "preferred"'),
    activeContracts: createAIField(24, 92, 'Active contract count from CRM', 'Producer_CRM.json', '"activeContracts": 24'),
  },
  {
    id: 'prod-002',
    name: createAIField('Mike Chen', 98, 'Producer name extracted from email signature', 'Email_Headers.json', '"from": "Mike Chen <mike.chen@premierbrokerage.com>"'),
    code: createAIField('PRB-1923', 99, 'Producer code from agency directory', 'Producer_Lookup.csv', '"producerCode": "PRB-1923"'),
    agency: createAIField('Premier Brokerage', 99, 'Agency name from producer directory', 'Producer_Lookup.csv', '"agency": "Premier Brokerage"'),
    license: createAIField('NY-LIC-445872', 97, 'License verified in state database', 'NY_License_Verification.json', '"licenseNumber": "NY-LIC-445872", "status": "Active"'),
    state: createAIField('NY', 99, 'State from license verification', 'NY_License_Verification.json', '"state": "NY"'),
    email: createAIField('mike.chen@premierbrokerage.com', 99, 'Email from submission header', 'Email_Headers.json', '"from": "mike.chen@premierbrokerage.com"'),
    phone: createAIField('(555) 456-7890', 95, 'Phone from producer directory', 'Producer_Lookup.csv', '"phone": "(555) 456-7890"'),
    tier: createAIField('preferred' as const, 98, 'Producer tier from agency relationship', 'Producer_Lookup.csv', '"tier": "preferred"'),
    activeContracts: createAIField(38, 92, 'Active contract count from CRM', 'Producer_CRM.json', '"activeContracts": 38'),
  },
  {
    id: 'prod-003',
    name: createAIField('Jennifer Walsh', 98, 'Producer name extracted from email signature', 'Email_Headers.json', '"from": "Jennifer Walsh <jennifer.walsh@globalriskmgmt.com>"'),
    code: createAIField('GRM-3156', 99, 'Producer code from agency directory', 'Producer_Lookup.csv', '"producerCode": "GRM-3156"'),
    agency: createAIField('Global Risk Management', 99, 'Agency name from producer directory', 'Producer_Lookup.csv', '"agency": "Global Risk Management"'),
    license: createAIField('TX-LIC-667234', 97, 'License verified in state database', 'TX_License_Verification.json', '"licenseNumber": "TX-LIC-667234", "status": "Active"'),
    state: createAIField('TX', 99, 'State from license verification', 'TX_License_Verification.json', '"state": "TX"'),
    email: createAIField('jennifer.walsh@globalriskmgmt.com', 99, 'Email from submission header', 'Email_Headers.json', '"from": "jennifer.walsh@globalriskmgmt.com"'),
    phone: createAIField('(555) 789-0123', 95, 'Phone from producer directory', 'Producer_Lookup.csv', '"phone": "(555) 789-0123"'),
    tier: createAIField('standard' as const, 98, 'Producer tier from agency relationship', 'Producer_Lookup.csv', '"tier": "standard"'),
    activeContracts: createAIField(15, 92, 'Active contract count from CRM', 'Producer_CRM.json', '"activeContracts": 15'),
  },
];
...
// Portal Submissions
export const portalSubmissions: PortalSubmission[] = [
  {
    id: 'portal-001',
    brokerName: 'Marsh McLennan',
    producerName: 'Robert Anderson',
    submissionId: 'MARSH-2025-CY-0892',
    receivedAt: '2025-12-26T11:30:00Z',
    metadataCompleteness: 92,
    insuredName: 'DataFlow Analytics Inc.',
    industry: 'Data Analytics',
    requestedLimit: 5000000,
    requestedDeductible: 50000,
    ...
    state: 'CO',
    attachments: [
      { id: 'patt-001', filename: 'ACORD_DataFlow.pdf', type: 'acord', size: '156 KB' },
      { id: 'patt-002', filename: 'Controls_Assessment.pdf', type: 'questionnaire', size: '89 KB' },
      { id: 'patt-003', filename: 'SOC2_Report.pdf', type: 'soc2', size: '2.1 MB' },
    ],
    isIngested: false,
    notes: 'Priority account - existing Marsh relationship',
  },
  {
    id: 'portal-002',
    brokerName: 'Aon Risk Solutions',
    producerName: 'Michelle Torres',
    submissionId: 'AON-2025-CY-1456',
    receivedAt: '2025-12-25T14:15:00Z',
    metadataCompleteness: 88,
    insuredName: 'CloudSecure Technologies',
    industry: 'Cloud Security',
    requestedLimit: 10000000,
    requestedDeductible: 100000,
    effectiveDate: '2026-03-01',
    expirationDate: '2027-03-01',
    ...
    state: 'WA',
    attachments: [
      { id: 'patt-004', filename: 'ACORD_CloudSecure.pdf', type: 'acord', size: '178 KB' },
      { id: 'patt-005', filename: 'Security_Questionnaire.pdf', type: 'questionnaire', size: '112 KB' },
    ],
    isIngested: false,
    notes: 'Renewal - increasing limits from $5M',
  },
  {
    id: 'portal-003',
    brokerName: 'Willis Towers Watson',
    producerName: 'James Patterson',
    submissionId: 'WTW-2025-CY-0234',
    receivedAt: '2025-12-24T09:45:00Z',
    metadataCompleteness: 75,
    insuredName: 'FinanceFirst Corp',
    industry: 'Financial Services',
    requestedLimit: 15000000,
    requestedDeductible: 150000,
    ...
    state: 'NY',
    attachments: [
      { id: 'patt-006', filename: 'ACORD_FinanceFirst.pdf', type: 'acord', size: '145 KB' },
    ],
    isIngested: false,
    notes: 'Missing controls questionnaire - requested from broker',
  },
];

// EDI / API Submissions
export const ediSubmissions: EDISubmission[] = [
  {
    id: 'edi-001',
    apiKeyName: 'PARTNER_LOCKTON_PROD',
    partnerName: 'Lockton Companies',
    submissionId: 'LOCK-API-2025-78234',
    schemaVersion: 'ACORD-XML-v2.1',
    receivedAt: '2025-12-26T08:22:00Z',
    structuredDataConfidence: 96,
    insuredName: 'SecureLogix Systems',
    industry: 'Cybersecurity Software',
    requestedLimit: 7500000,
    requestedDeductible: 75000,
    effectiveDate: '2026-01-15',
    expirationDate: '2027-01-15',
    ...
    state: 'TX',
    acordData: {
      applicationType: 'New Business',
      policyForm: 'Claims-Made',
      retroactiveDate: '2020-01-01',
      extendedReportingPeriod: 90,
    },
    isIngested: false,
    validationErrors: [],
  },
  {
    id: 'edi-002',
    apiKeyName: 'PARTNER_GALLAGHER_PROD',
    partnerName: 'Arthur J. Gallagher',
    submissionId: 'AJG-API-2025-45891',
    schemaVersion: 'ACORD-JSON-v1.5',
    receivedAt: '2025-12-25T16:40:00Z',
    structuredDataConfidence: 92,
    insuredName: 'MedData Solutions LLC',
    ...
    acordData: {
      ...
      policyForm: 'Claims-Made',
      retroactiveDate: '2022-02-15',
      extendedReportingPeriod: 60,
    },
    isIngested: false,
    validationErrors: [],
  },
  {
    id: 'edi-003',
    apiKeyName: 'PARTNER_HUB_PROD',
    partnerName: 'Hub International',
    submissionId: 'HUB-API-2025-12567',
    schemaVersion: 'ACORD-XML-v2.0',
    receivedAt: '2025-12-24T12:15:00Z',
    structuredDataConfidence: 78,
    insuredName: 'RetailChain Dynamics',
    industry: 'Retail Technology',
    requestedLimit: 3000000,
    requestedDeductible: 25000,
    effectiveDate: '2026-03-01',
    expirationDate: '2027-03-01',
    ...
    isIngested: false,
    validationErrors: ['Missing PHI record count', 'Cloud provider not specified'],
  },
];
...
export const initialSubmissions: Submission[] = [
  {
    ...
    reviewReason: 'EDR status unclear - requires manual verification',
  },
  {
    id: 'sub-zenith-001',
    scenarioId: 'scenario-b',
    stage: 'pricing',
    substage: 'quote_draft',
    source: 'email',
    sourceEmail: brokerEmails[1],
    ...
    history: [
      ...
      },
      {
        ...
        description: 'Auto-assigned to Lisa Park (high confidence)',
      },
    ],
    feedbackLog: [],
    confidence: 94,
  ...
  },
  {
    ...
    confidence: 78,
    requiresHumanReview: true,
    reviewReason: 'Complex submission - requires specialist review due to prior claims history',
  },
  {
    id: 'sub-techglobal-001',
    scenarioId: 'scenario-d',
    stage: 'quotation',
    substage: 'quote_review',
    source: 'edi',
    sourceEmail: brokerEmails[0],
    producer: producers[0],
    insured: {
      ...acmeInsured,
      name: createAIField('TechGlobal Solutions Inc.', 96, 'Extracted from application', 'ACORD.json', '"name": "TechGlobal Solutions Inc."'),
      industry: createAIField('Enterprise Software', 94, 'Industry classification', 'ACORD.json', '"industry": "Enterprise Software"'),
      annualRevenue: createAIField(85000000, 92, 'Annual revenue', 'ACORD.json', '"revenue": 85000000'),
      city: createAIField('Austin', 98, 'City', 'ACORD.json', '"city": "Austin"'),
      state: createAIField('TX', 98, 'State', 'ACORD.json', '"state": "TX"'),
    },
    controls: zenithControls,
    riskProfile: zenithRiskProfile,
    coverages: zenithCoverages,
  ...
  },
  {
    ...
    insured: {
      ...acmeInsured,
      name: createAIField('HealthNet Medical Systems', 98, 'Extracted from application', 'ACORD.json', '"name": "HealthNet Medical Systems"'),
      industry: createAIField('Healthcare IT', 96, 'Industry classification', 'ACORD.json', '"industry": "Healthcare IT"'),
      annualRevenue: createAIField(62000000, 94, 'Annual revenue', 'ACORD.json', '"revenue": 62000000'),
      city: createAIField('Boston', 98, 'City', 'ACORD.json', '"city": "Boston"'),
      state: createAIField('MA', 98, 'State', 'ACORD.json', '"state": "MA"'),
    },
    controls: zenithControls,
    riskProfile: zenithRiskProfile,
    coverages: acmeCoverages,
  ...
  },
  {
    ...
    insured: {
      ...zenithInsured,
      name: createAIField('RetailPro Commerce Ltd', 94, 'Extracted from application', 'ACORD.json', '"name": "RetailPro Commerce Ltd"'),
      industry: createAIField('E-Commerce Platform', 92, 'Industry classification', 'ACORD.json', '"industry": "E-Commerce Platform"'),
      annualRevenue: createAIField(38000000, 88, 'Annual revenue', 'ACORD.json', '"revenue": 38000000'),
      city: createAIField('Seattle', 98, 'City', 'ACORD.json', '"city": "Seattle"'),
    ...
    confidence: 65,
    requiresHumanReview: true,
    reviewReason: 'New submission - pending document parsing',
  },
  {
    id: 'sub-cyberdefense-001',
    scenarioId: 'scenario-g',
    stage: 'assignment',
    substage: 'workload_balance',
    source: 'edi',
    sourceEmail: brokerEmails[0],
    producer: producers[0],
    insured: {
      ...zenithInsured,
      name: createAIField('CyberDefense Corp', 96, 'Extracted from application', 'ACORD.json', '"name": "CyberDefense Corp"'),
      industry: createAIField('Cybersecurity Services', 94, 'Industry classification', 'ACORD.json', '"industry": "Cybersecurity Services"'),
      annualRevenue: createAIField(55000000, 92, 'Annual revenue', 'ACORD.json', '"revenue": 55000000'),
      city: createAIField('San Francisco', 98, 'City', 'ACORD.json', '"city": "San Francisco"'),
      state: createAIField('CA', 98, 'State', 'ACORD.json', '"state": "CA"'),
    },
    controls: zenithControls,
    riskProfile: zenithRiskProfile,
    coverages: zenithCoverages,
    ...
    history: [
      ...
      },
      {
        ...
        actorRole: 'intake',
        description: 'Intake completed with high confidence - moved to assignment',
      },
    ],
    feedbackLog: [],
    confidence: 91,
  ...
  },
  {
    ...
    insured: {
      ...acmeInsured,
      name: createAIField('MediTech Solutions', 97, 'Extracted from application', 'ACORD.json', '"name": "MediTech Solutions"'),
      industry: createAIField('Healthcare Technology', 95, 'Industry classification', 'ACORD.json', '"industry": "Healthcare Technology"'),
      annualRevenue: createAIField(72000000, 94, 'Annual revenue', 'ACORD.json', '"revenue": 72000000'),
      city: createAIField('Chicago', 98, 'City', 'ACORD.json', '"city": "Chicago"'),
      state: createAIField('IL', 98, 'State', 'ACORD.json', '"state": "IL"'),
    },
    controls: zenithControls,
    riskProfile: acmeRiskProfile,
    coverages: acmeCoverages,
